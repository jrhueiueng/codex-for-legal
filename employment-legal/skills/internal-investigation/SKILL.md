...
Prepend the work-product header from `~/.codex/plugins/config/codex-for-legal/employment-legal/CLAUDE.md` → `## Outputs` (it differs by user role — see `## Who's using this`). Every file, log, memo, and summary produced by this skill opens with that header.
...
Read `~/.codex/plugins/config/codex-for-legal/employment-legal/CLAUDE.md` → escalation table, any investigation protocols noted.
...
`~/.codex/plugins/config/codex-for-legal/employment-legal/investigation-[matter-slug]/log.yaml`:
...
`~/.codex/plugins/config/codex-for-legal/employment-legal/investigation-[matter-slug]/sources-checklist.yaml`:

Generated from the investigation type. See sources checklist templates below.

`~/.codex/plugins/config/codex-for-legal/employment-legal/investigation-[matter-slug]/documents-reviewed.yaml`:
...
`~/.codex/plugins/config/codex-for-legal/employment-legal/investigation-[slug]/sources-checklist.yaml`.
...
If multiple investigation folders exist in `~/.codex/plugins/config/codex-for-legal/employment-legal/`, ask which matter this
...
Write the draft to `~/.codex/plugins/config/codex-for-legal/employment-legal/investigation-[slug]/memo.md`.
