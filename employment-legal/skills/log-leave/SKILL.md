...
Adds a new leave entry to `~/.codex/plugins/config/codex-for-legal/employment-legal/leave-register.yaml` with the minimum
...
1. Read `~/.codex/plugins/config/codex-for-legal/employment-legal/CLAUDE.md` → jurisdiction table and Systems section.
...
3. Using the jurisdiction table in `~/.codex/plugins/config/codex-for-legal/employment-legal/CLAUDE.md`, look up the applicable leave
...
5. Write a new entry to `~/.codex/plugins/config/codex-for-legal/employment-legal/leave-register.yaml` using the leave register
