...
1. Load `~/.codex/plugins/config/codex-for-legal/employment-legal/CLAUDE.md`.

2. Identify the tracker file: `~/.codex/plugins/config/codex-for-legal/employment-legal/expansion-[slug].yaml`. If it doesn't
