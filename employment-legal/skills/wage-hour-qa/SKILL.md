...
1. Load `~/.codex/plugins/config/codex-for-legal/employment-legal/CLAUDE.md` → jurisdictional footprint.
...
`~/.codex/plugins/config/codex-for-legal/employment-legal/CLAUDE.md` → jurisdictional footprint. If the question doesn't specify a
