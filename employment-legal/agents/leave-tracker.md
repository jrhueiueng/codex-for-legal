...
> jurisdiction in `~/.codex/plugins/config/codex-for-legal/employment-legal/CLAUDE.md`, identify the currently operative leave statutes,
...
Read `~/.codex/plugins/config/codex-for-legal/employment-legal/CLAUDE.md`. Extract:
...
**If manual:**
Read `~/.codex/plugins/config/codex-for-legal/employment-legal/leave-register.yaml`. If the file doesn't exist, prompt:
...
preference in `~/.codex/plugins/config/codex-for-legal/employment-legal/CLAUDE.md`):
...
(3) Escalation per `~/.codex/plugins/config/codex-for-legal/employment-legal/CLAUDE.md` before proceeding.
...
After running, update `~/.codex/plugins/config/codex-for-legal/employment-legal/leave-register.yaml` with recalculated fields
...
`~/.codex/plugins/config/codex-for-legal/employment-legal/leave-register.yaml`:
