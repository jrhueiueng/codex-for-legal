...
1. **Read the config.** Read
   `~/.codex/plugins/config/codex-for-legal/ai-governance-legal/CLAUDE.md`
   (and `~/.codex/plugins/config/codex-for-legal/company-profile.md` one
...
5. **For shared-profile changes** (company name, industry, jurisdictions,
   ...
   `~/.codex/plugins/config/codex-for-legal/company-profile.md` and note:
