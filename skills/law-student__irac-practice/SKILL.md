...
1. Load `~/.codex/plugins/config/codex-for-legal/law-student/CLAUDE.md` → classes, exam formats, outline locations, learning style.
...
6. Append to `~/.codex/plugins/config/codex-for-legal/law-student/irac-sessions/[student]/tracker.md` for pattern detection. Surface patterns after 3+ sessions.
...
- `~/.codex/plugins/config/codex-for-legal/law-student/CLAUDE.md` → current classes, exam formats, outline locations, learning style
- `~/.codex/plugins/config/codex-for-legal/law-student/irac-sessions/[student]/tracker.md` if exists — pattern tracking across sessions
...
Append to `~/.codex/plugins/config/codex-for-legal/law-student/irac-sessions/[student]/tracker.md`:
