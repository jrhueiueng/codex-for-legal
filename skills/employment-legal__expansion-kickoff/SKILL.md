...
3. If a tracker file already exists for this country (`~/.codex/plugins/config/codex-for-legal/employment-legal/expansion-[slug].yaml`),
...
4. Create `~/.codex/plugins/config/codex-for-legal/employment-legal/expansion-[slug].yaml` on completion.
