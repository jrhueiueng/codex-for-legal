...
1. Read `~/.codex/plugins/config/codex-for-legal/ip-legal/CLAUDE.md`. If it
...
Before running clearance, read `~/.codex/plugins/config/codex-for-legal/ip-legal/CLAUDE.md`. Pull:
...
If `~/.codex/plugins/config/codex-for-legal/ip-legal/CLAUDE.md` contains `[PLACEHOLDER]` or `[Your Company Name]`, surface this bounce:
...
Read `## Available integrations` from `~/.codex/plugins/config/codex-for-legal/ip-legal/CLAUDE.md`:
...
Per the decision posture in `~/.codex/plugins/config/codex-for-legal/ip-legal/CLAUDE.md`:
...
Prepend the work-product header from `~/.codex/plugins/config/codex-for-legal/ip-legal/CLAUDE.md` `## Outputs`.
...
- [routing per `~/.codex/plugins/config/codex-for-legal/ip-legal/CLAUDE.md` —
...
`~/.codex/plugins/config/codex-for-legal/ip-legal/matters/<matter-slug>/outputs/clearance-<mark-slug>-YYYY-MM-DD.md`.
Otherwise write to
`~/.codex/plugins/config/codex-for-legal/ip-legal/outputs/clearance-<mark-slug>-YYYY-MM-DD.md`
