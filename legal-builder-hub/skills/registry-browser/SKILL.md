...
1. Load `~/.codex/plugins/config/codex-for-legal/legal-builder-hub/CLAUDE.md` → watched registries.
...
`~/.codex/plugins/config/codex-for-legal/legal-builder-hub/CLAUDE.md` → watched registries list.
...
2. Show what's in it
3. Add to `~/.codex/plugins/config/codex-for-legal/legal-builder-hub/CLAUDE.md` → watched registries on confirmation
