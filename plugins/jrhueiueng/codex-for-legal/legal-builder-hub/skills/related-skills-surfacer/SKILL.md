...
1. Load `~/.codex/plugins/config/codex-for-legal/legal-builder-hub/CLAUDE.md` → practice profile.
...
`~/.codex/plugins/config/codex-for-legal/legal-builder-hub/CLAUDE.md` → practice profile, installed skills (don't suggest what's already installed).
...
Per `~/.codex/plugins/config/codex-for-legal/legal-builder-hub/CLAUDE.md` → new skill notifications:
