...
1. Load `~/.codex/plugins/config/codex-for-legal/law-student/CLAUDE.md` → class, writing skill level, past feedback patterns.
...
7. Append to `~/.codex/plugins/config/codex-for-legal/law-student/writing-feedback/[student]/tracker.md` for pattern detection.
...
- `~/.codex/plugins/config/codex-for-legal/law-student/CLAUDE.md` → class, assignment type (if known), writing skill level, graded-essay feedback history
...
Append session summary to `~/.codex/plugins/config/codex-for-legal/law-student/writing-feedback/[student]/tracker.md`:
