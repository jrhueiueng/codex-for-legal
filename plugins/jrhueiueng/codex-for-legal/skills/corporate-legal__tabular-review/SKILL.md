...
1. Load `~/.codex/plugins/config/codex-for-legal/corporate-legal/CLAUDE.md` → diligence structure, thresholds, house format.
...
- `~/.codex/plugins/config/codex-for-legal/corporate-legal/CLAUDE.md` → diligence structure, materiality thresholds, house format preferences
- `~/.codex/plugins/config/codex-for-legal/corporate-legal/deals/[code]/deal-context.md` if working a specific deal
