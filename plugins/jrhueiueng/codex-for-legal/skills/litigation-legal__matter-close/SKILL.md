...
5. Append final entry to `~/.codex/plugins/config/codex-for-legal/litigation-legal/matters/[slug]/history.md`.
6. Matter stays in `_log.yaml` and `~/.codex/plugins/config/codex-for-legal/litigation-legal/matters/[slug]/` — not deleted. `/portfolio-status` filters it from active rollups.
...
- `~/.codex/plugins/config/codex-for-legal/litigation-legal/matters/[slug]/matter.md` — reference (intake context)
...
**Before closing the matter (the consequential act — the matter is archived and active tracking ends):** Read `## Who's using this` in `~/.codex/plugins/config/codex-for-legal/litigation-legal/CLAUDE.md`. If the Role is Non-lawyer:
...
### Append final entry to `~/.codex/plugins/config/codex-for-legal/litigation-legal/matters/[slug]/history.md`
...
### Touch `~/.codex/plugins/config/codex-for-legal/litigation-legal/matters/[slug]/matter.md`
