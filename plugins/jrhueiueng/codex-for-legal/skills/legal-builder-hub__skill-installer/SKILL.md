...
1. **Read the allowlist first.** `~/.codex/plugins/config/codex-for-legal/legal-builder-hub/allowlist.yaml`. If restrictive mode and source not listed: refuse. If permissive: warn and continue.
...
7. **Install.** Copy the directory. Update `~/.codex/plugins/config/codex-for-legal/legal-builder-hub/CLAUDE.md` and append to `install-log.yaml`.
...
Read `~/.codex/plugins/config/codex-for-legal/legal-builder-hub/allowlist.yaml`.
...
`~/.codex/plugins/config/codex-for-legal/legal-builder-hub/CLAUDE.md`:
...
Record in `~/.codex/plugins/config/codex-for-legal/legal-builder-hub/CLAUDE.md`
...
`~/.codex/plugins/config/codex-for-legal/legal-builder-hub/install-log.yaml`
