...
1. Read `~/.codex/plugins/config/codex-for-legal/privacy-legal/CLAUDE.md` → outputs folder path, policy document, last sweep date.
...
6. Update Last policy sweep date in `~/.codex/plugins/config/codex-for-legal/privacy-legal/CLAUDE.md`.

**Direct query mode** (with description argument):
1. Read `~/.codex/plugins/config/codex-for-legal/privacy-legal/CLAUDE.md` → current policy commitments + actual policy document.
...
Update **Last policy sweep** in `~/.codex/plugins/config/codex-for-legal/privacy-legal/CLAUDE.md` to today's date after completing the sweep.
...
`~/.codex/plugins/config/codex-for-legal/privacy-legal/CLAUDE.md`, so the next sweep only looks at new files.
