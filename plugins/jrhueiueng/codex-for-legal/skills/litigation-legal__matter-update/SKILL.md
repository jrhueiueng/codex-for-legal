...
2. Confirm slug exists in `~/.codex/plugins/config/codex-for-legal/litigation-legal/matters/` and `_log.yaml`.
...
4. Append dated entry to `~/.codex/plugins/config/codex-for-legal/litigation-legal/matters/[slug]/history.md`.
...
- `~/.codex/plugins/config/codex-for-legal/litigation-legal/matters/_log.yaml` — find the row
- `~/.codex/plugins/config/codex-for-legal/litigation-legal/matters/[slug]/history.md` — append target
- `~/.codex/plugins/config/codex-for-legal/litigation-legal/matters/[slug]/matter.md` — reference (don't rewrite)
- `~/.codex/plugins/config/codex-for-legal/litigation-legal/CLAUDE.md` — risk calibration (if re-assessing risk)
...
If the Strategy update is a **settlement acceptance** (the company is accepting a settlement offer, executing a settlement agreement, or authorizing acceptance in principle — not merely logging an offer made or received): Read `## Who's using this` in `~/.codex/plugins/config/codex-for-legal/litigation-legal/CLAUDE.md`. If the Role is Non-lawyer:
...
If materiality moves to `reserved` or `disclosed`, and the matter did not previously carry a reserve or disclosure, flag the event as requiring finance / audit-committee notification per `~/.codex/plugins/config/codex-for-legal/litigation-legal/CLAUDE.md` materiality thresholds.
...
### Append to `~/.codex/plugins/config/codex-for-legal/litigation-legal/matters/[slug]/history.md`
...
### Update `~/.codex/plugins/config/codex-for-legal/litigation-legal/matters/_log.yaml`
