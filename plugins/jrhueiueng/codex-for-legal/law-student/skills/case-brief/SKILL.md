...
1. Load `~/.codex/plugins/config/codex-for-legal/law-student/CLAUDE.md` → outline/brief preferences.
...
`~/.codex/plugins/config/codex-for-legal/law-student/CLAUDE.md` → outline/brief preferences (format, depth), learning style.
...
Per the student's format in `~/.codex/plugins/config/codex-for-legal/law-student/CLAUDE.md`. If none captured, default:
...
Per `~/.codex/plugins/config/codex-for-legal/law-student/CLAUDE.md` — some students want one-line briefs (rule + cite), some want full treatment. Match their format.
