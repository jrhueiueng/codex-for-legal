...
1. Read `~/.codex/plugins/config/codex-for-legal/privacy-legal/CLAUDE.md`. Confirm privacy practice is configured — if not, stop and direct to setup.
...
Before triaging, always read `~/.codex/plugins/config/codex-for-legal/privacy-legal/CLAUDE.md`. The PIA trigger criteria, regulatory
...
Read `~/.codex/plugins/config/codex-for-legal/privacy-legal/CLAUDE.md` → `## PIA house style` → Trigger criteria. Apply them.
...
Read `~/.codex/plugins/config/codex-for-legal/privacy-legal/CLAUDE.md` → `## Privacy policy commitments`. Check the proposed activity
...
> required in addition to a PIA. Use `/privacy-legal:aia-generation [activity]`
...
> Use `/privacy-legal:launch-review` — it will detect the privacy component
