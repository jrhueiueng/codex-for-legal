...
description: >
  ...
  assessment in `~/.codex/plugins/config/codex-for-legal/ai-governance-legal/CLAUDE.md`.
...
1. Read `~/.codex/plugins/config/codex-for-legal/ai-governance-legal/CLAUDE.md`. Confirm impact assessment house style is populated.
...
6. Policy diff against `~/.codex/plugins/config/codex-for-legal/ai-governance-legal/CLAUDE.md` AI policy commitments.
...
- Is the use case in the elevated or high governance tier per `~/.codex/plugins/config/codex-for-legal/ai-governance-legal/CLAUDE.md`?
...
Before intake, determine which track to run. The tier definitions and the fast-track criteria come from `~/.codex/plugins/config/codex-for-legal/ai-governance-legal/CLAUDE.md` (`## Use case registry` and `## Governance tiers`), not from any hardcoded regime-specific framework.
...
**Fast track vs. full assessment:** `~/.codex/plugins/config/codex-for-legal/ai-governance-legal/CLAUDE.md` defines what qualifies for abbreviated treatment. If `~/.codex/plugins/config/codex-for-legal/ai-governance-legal/CLAUDE.md` doesn't define fast-track criteria, default to full assessment and ask the user what criteria they want captured for next time.
...
For each regime in `~/.codex/plugins/config/codex-for-legal/ai-governance-legal/CLAUDE.md` → `## Regulatory footprint` that applies to this system — **plus any regime surfaced by the re-derivation above** — research the currently operative risk classification framework and determine where the system lands.
...
**Use the seed structure from `~/.codex/plugins/config/codex-for-legal/ai-governance-legal/CLAUDE.md`.** If none was captured, use this default:
...
|---|---|---|
| [commitment from `~/.codex/plugins/config/codex-for-legal/ai-governance-legal/CLAUDE.md` AI policy section] | 🟢 / 🟡 / 🟠 / 🔴 | |
...
**Privacy review required?** [Yes — run `/ai-governance-legal:pia-generation`, if the plugin is installed /
No]
...
**Before certifying the AIA (the Sign-off step, marking Status: APPROVED):** Read `## Who's using this` in `~/.codex/plugins/config/codex-for-legal/ai-governance-legal/CLAUDE.md`. If the Role is Non-lawyer:
...
Every assessment should cross-check against the AI policy commitments in `~/.codex/plugins/config/codex-for-legal/ai-governance-legal/CLAUDE.md`.
Common drift:
...
- **To privacy:** If personal data is involved, flag: "Run `/ai-governance-legal:pia-generation [system name]` in parallel, if the plugin is installed — the AIA doesn't substitute for a PIA."
