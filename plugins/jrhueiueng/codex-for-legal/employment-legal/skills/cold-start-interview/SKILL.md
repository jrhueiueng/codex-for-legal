...
6. Write `~/.codex/plugins/config/codex-for-legal/employment-legal/CLAUDE.md`, creating parent directories as needed.
...
Read `~/.codex/plugins/config/codex-for-legal/employment-legal/CLAUDE.md`:
...
> **`employment-legal` is for people who handle hiring, terminations, investigations, leave, policies, worker classification, and international expansion.** Not your area? `/employment-legal:related-skills-surfacer`.
>
...
> "Done. Your configuration is at `~/.codex/plugins/config/codex-for-legal/employment-legal/CLAUDE.md` — a plain text file you can read and edit directly. Anything you answered can be changed:
>
