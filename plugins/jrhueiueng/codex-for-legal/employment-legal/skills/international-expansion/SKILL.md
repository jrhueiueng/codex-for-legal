...
Read `~/.codex/plugins/config/codex-for-legal/employment-legal/CLAUDE.md` → jurisdictional footprint, escalation table, any existing
expansion notes.
...
Write a new file to `~/.codex/plugins/config/codex-for-legal/employment-legal/expansion-[country-slug].yaml` with all open items
...
**Roles:** [list]
**Tracker:** ~/.codex/plugins/config/codex-for-legal/employment-legal/expansion-[slug].yaml
