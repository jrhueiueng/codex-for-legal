...
`~/.codex/plugins/config/codex-for-legal/employment-legal/CLAUDE.md` → handbook location, state supplements list, update cadence.
...
For each state supplement in `~/.codex/plugins/config/codex-for-legal/employment-legal/CLAUDE.md`:
