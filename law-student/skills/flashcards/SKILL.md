...
1. Load `~/.codex/plugins/config/codex-for-legal/law-student/CLAUDE.md` → current classes, weak subjects, outline locations.
2. Apply the framework below.
3. Route by flag:
   - `--generate`: build cards from source (outline path, notes, casebook) per card-writing rules. Write to `~/.codex/plugins/config/codex-for-legal/law-student/flashcards/[subject]/cards.md`.
...
- `~/.codex/plugins/config/codex-for-legal/law-student/CLAUDE.md` → current classes, weak subjects, existing outlines
- `~/.codex/plugins/config/codex-for-legal/law-student/flashcards/[subject]/cards.md` if it exists (incremental build)
...
- Load `~/.codex/plugins/config/codex-for-legal/law-student/study-plan.yaml` if it exists and read `session_history` for this subject.
...
- If no `study-plan.yaml`, write to `~/.codex/plugins/config/codex-for-legal/law-student/session-history.yaml` instead.

### `--generate` — create cards

**Inputs:**
- Subject (class name or topic)
- Source (outline path, notes, or "use my existing outline from ~/.codex/plugins/config/codex-for-legal/law-student/CLAUDE.md")
