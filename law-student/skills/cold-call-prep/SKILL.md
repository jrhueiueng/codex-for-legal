...
1. Load `~/.codex/plugins/config/codex-for-legal/law-student/CLAUDE.md` → class list, professors, learning style.
...
- `~/.codex/plugins/config/codex-for-legal/law-student/CLAUDE.md` → current classes, professors, learning style
...
- Professor (from ~/.codex/plugins/config/codex-for-legal/law-student/CLAUDE.md class list — tone and focus vary by professor)
- Class / subject area
...
**Professor-specific flavor (from ~/.codex/plugins/config/codex-for-legal/law-student/CLAUDE.md notes):**
...
- **Predict jurisdiction-specific niche questions.** If the professor has known hobby horses, capture them in ~/.codex/plugins/config/codex-for-legal/law-student/CLAUDE.md class notes and the skill can weight accordingly; otherwise, it works from general patterns.
