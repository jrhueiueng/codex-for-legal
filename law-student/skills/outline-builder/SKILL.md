...
1. Load `~/.codex/plugins/config/codex-for-legal/law-student/CLAUDE.md` → outline preferences, existing outlines.
...
1. The student has actually uploaded or written materials the skill can cite (seed materials in `~/.codex/plugins/config/codex-for-legal/law-student/CLAUDE.md` → Seed materials, or an earlier section of the outline being extended), and
...
`~/.codex/plugins/config/codex-for-legal/law-student/CLAUDE.md` → outline preferences (format, depth, existing outlines location).
