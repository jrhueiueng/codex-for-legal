...
1. Load `~/.codex/plugins/config/codex-for-legal/law-student/CLAUDE.md` → bar jurisdiction, exam format, bar date, weak subjects, target study hours/day, prep course.
2. Load `~/.codex/plugins/config/codex-for-legal/law-student/study-plan.yaml` if it exists.
...
`~/.codex/plugins/config/codex-for-legal/law-student/CLAUDE.md`:
...
`~/.codex/plugins/config/codex-for-legal/law-student/study-plan.yaml` if it exists — extend, don't overwrite.
...
Write to `~/.codex/plugins/config/codex-for-legal/law-student/study-plan.yaml`:
