...
1. Load `~/.codex/plugins/config/codex-for-legal/legal-clinic/CLAUDE.md` → practice areas, jurisdiction.
...
`~/.codex/plugins/config/codex-for-legal/legal-clinic/CLAUDE.md` → practice areas, jurisdiction, supervision style.
