...
1. Check `~/.codex/plugins/config/codex-for-legal/legal-clinic/CLAUDE.md` is set up. If placeholders: "Ask [professor] to run `/legal-clinic:cold-start-interview` first."
...
`~/.codex/plugins/config/codex-for-legal/legal-clinic/CLAUDE.md` → clinic profile, practice areas, jurisdiction, handbook path, supervision style, practice-area templates.
...
Read from `~/.codex/plugins/config/codex-for-legal/legal-clinic/CLAUDE.md` and the ingested handbook. Cover, interactively:
