...
description: >
  ...
  Runs weekly by default. Posts to the channel named in `~/.codex/plugins/config/codex-for-legal/commercial-legal/CLAUDE.md` → House style
...
1. Read `~/.codex/plugins/config/codex-for-legal/commercial-legal/CLAUDE.md` to get the alert destination (Slack channel or email list).
