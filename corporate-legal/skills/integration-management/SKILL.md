...
5. Read/write `~/.codex/plugins/config/codex-for-legal/corporate-legal/deals/[code]/integration-tracker.yaml`.
...
Lives at `~/.codex/plugins/config/codex-for-legal/corporate-legal/deals/[code]/integration-tracker.yaml`. Read `deal-context.md` for
...
Read `~/.codex/plugins/config/codex-for-legal/corporate-legal/deals/[code]/deal-context.md`. If not found: ask for deal code name,
target company, close date, deal lead, and outside counsel. Write to
deal-context.md if it doesn't exist.

Read `~/.codex/plugins/config/codex-for-legal/corporate-legal/deals/[code]/closing-checklist.yaml` if it exists. Any items marked as
...
>   automatically from `~/.codex/plugins/config/codex-for-legal/corporate-legal/deals/[code]/closing-checklist.yaml`
