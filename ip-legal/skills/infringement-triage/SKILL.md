...
Read `~/.codex/plugins/config/codex-for-legal/ip-legal/CLAUDE.md`. Pull:
...
invalidity contentions, run `/ip-legal:claim-chart`. This triage's
...
`~/.codex/plugins/config/codex-for-legal/ip-legal/matters/<matter-slug>/outputs/infringe-<mode>-<subject-slug>-YYYY-MM-DD.md`.
Otherwise write to
`~/.codex/plugins/config/codex-for-legal/ip-legal/outputs/infringe-<mode>-<subject-slug>-YYYY-MM-DD.md`
