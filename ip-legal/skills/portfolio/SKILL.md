...
1. **Follow the workflow below** and read
   `~/.codex/plugins/config/codex-for-legal/ip-legal/portfolio.yaml`.
...
Lives at `~/.codex/plugins/config/codex-for-legal/ip-legal/portfolio.yaml`.
Structure:
...
Output (prepend work-product header per `~/.codex/plugins/config/codex-for-legal/ip-legal/CLAUDE.md` → Outputs):
...
`## Who's using this` in `~/.codex/plugins/config/codex-for-legal/ip-legal/CLAUDE.md`. If the Role is **Non-lawyer**:
