...
3. If grand jury → stop, escalate per `~/.codex/plugins/config/codex-for-legal/litigation-legal/CLAUDE.md`. Otherwise continue.
4. Load `~/.codex/plugins/config/codex-for-legal/litigation-legal/matters/_log.yaml` for cross-check. Load `~/.codex/plugins/config/codex-for-legal/litigation-legal/CLAUDE.md` → landscape, privilege conventions, escalation norms.
...
7. Write `~/.codex/plugins/config/codex-for-legal/litigation-legal/inbound/[slug]/triage.md`. Copy or link subpoena to `~/.codex/plugins/config/codex-for-legal/litigation-legal/inbound/[slug]/incoming.[ext]`.
...
- `~/.codex/plugins/config/codex-for-legal/litigation-legal/matters/_log.yaml` — for related matter lookup and legal hold status
- `~/.codex/plugins/config/codex-for-legal/litigation-legal/CLAUDE.md` → landscape (regulators we deal with), house privilege conventions, escalation norms
...
- Privilege log will be required — flag the format per `~/.codex/plugins/config/codex-for-legal/litigation-legal/CLAUDE.md`
...
Output: `~/.codex/plugins/config/codex-for-legal/litigation-legal/inbound/[slug]/triage.md`.
...
**Privilege log format required:** [per `~/.codex/plugins/config/codex-for-legal/litigation-legal/CLAUDE.md`]
...
**Before responding to the subpoena (serving objections, producing documents, appearing for deposition, or filing a motion to quash — any substantive response to the issuing party or court):** Read `## Who's using this` in `~/.codex/plugins/config/codex-for-legal/litigation-legal/CLAUDE.md`. If the Role is Non-lawyer:
...
- If classified as **grand jury subpoena** → stop, flag for escalation per `~/.codex/plugins/config/codex-for-legal/litigation-legal/CLAUDE.md`, do not proceed with standard triage.
