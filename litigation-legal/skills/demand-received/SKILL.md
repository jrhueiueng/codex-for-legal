...
2. Load `~/.codex/plugins/config/codex-for-legal/litigation-legal/matters/_log.yaml` for portfolio cross-check.
3. Load `~/.codex/plugins/config/codex-for-legal/litigation-legal/CLAUDE.md` → risk calibration, landscape, demand-letter practice.
...
6. Write `~/.codex/plugins/config/codex-for-legal/litigation-legal/inbound/[slug]/triage.md`. Copy or link incoming to `~/.codex/plugins/config/codex-for-legal/litigation-legal/inbound/[slug]/incoming.[ext]`.
...
- `~/.codex/plugins/config/codex-for-legal/litigation-legal/matters/_log.yaml` — scan for related matters (same counterparty, overlapping counterparties via entity relationships, or matter type + recent date)
- `~/.codex/plugins/config/codex-for-legal/litigation-legal/CLAUDE.md` → risk calibration (for merit assessment), landscape (is the sender a frequent adversary?), demand-letter practice (house tone and response defaults)
...
- **Leverage and pressure** — are they credibly prepared to sue? Do they have capacity? Are they a repeat-litigant adversary per `~/.codex/plugins/config/codex-for-legal/litigation-legal/CLAUDE.md`?
...
- Standalone → leave in `~/.codex/plugins/config/codex-for-legal/litigation-legal/inbound/`; no portfolio change.
