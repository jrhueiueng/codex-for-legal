...
- `/litigation-legal:matter-workspace close <slug>` — archive a matter (move to `~/.codex/plugins/config/codex-for-legal/litigation-legal/matters/_archived/`, never delete)
...
```
~/.codex/plugins/config/codex-for-legal/litigation-legal/
