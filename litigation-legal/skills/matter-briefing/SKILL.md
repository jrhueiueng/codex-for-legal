...
1. Load `~/.codex/plugins/config/codex-for-legal/litigation-legal/CLAUDE.md` → risk calibration + relevant stakeholders.
2. Follow the workflow and reference below.
3. Read `~/.codex/plugins/config/codex-for-legal/litigation-legal/matters/[slug]/matter.md` + `~/.codex/plugins/config/codex-for-legal/litigation-legal/matters/[slug]/history.md` + log row from `_log.yaml`.
...
- `~/.codex/plugins/config/codex-for-legal/litigation-legal/matters/_log.yaml` — structured row
- `~/.codex/plugins/config/codex-for-legal/litigation-legal/matters/[slug]/matter.md` — narrative intake
- `~/.codex/plugins/config/codex-for-legal/litigation-legal/matters/[slug]/history.md` — event log
- `~/.codex/plugins/config/codex-for-legal/litigation-legal/CLAUDE.md` — risk calibration (so "risk: high" means something specific, not generic)
